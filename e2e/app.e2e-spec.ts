...
////////////////////all tests related to all-games page
  ...
  //   // let firstGame = element.all(by.css(".games div.game")).get(4);
  //   let deleteButton = element.all('.games .game .delete').first();

  //   deleteButton.click();

  //   // let numberOfGamesAfterDelete = element.all(by.css(".games")).count();
